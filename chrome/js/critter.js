...
for (var i = 0; i <comments.length; i++){
  ...
  "<img src='"+chrome.extension.getURL("img/"+critters[Math.floor(Math.random()*critters.length)]+"_rest.png")+"' class='critter' title=\""+comments[i].slice(4,comments[i].length-3)+"!\"></img>");
}
$('body').html(pageHTML);
/*
